...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (a, b, c) {
    ...
    b.module("ui.router.coreUtil", ["ng"]), b.module("ui.router.router", ["ui.router.coreUtil"]), b.module("ui.router.state", ["ui.router.router", "ui.router.coreUtil"]), b.module("ui.router", ["ui.router.state"]), b.module("ui.router.compat", ["ui.router"]), o.$inject = ["$q", "$injector"], b.module("ui.router.coreUtil").service("$resolve", o), p.$inject = ["$http", "$templateCache", "$injector"], b.module("ui.router.coreUtil").service("$templateFactory", p);
    var O;
    q.prototype.concat = function (a, b) {
        ...
        return new d(this, a)
    }, b.module("ui.router.coreUtil").provider("$urlMatcherFactory", s), b.module("ui.router.coreUtil").run(["$urlMatcherFactory", function () {
